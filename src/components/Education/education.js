...
import schoolIcon from '../../assets/schools.JPG';
...
const educationData = [
  ...
  {
    degree: 'Senior Secondary (Class 12th) – RBSE',
    institution: 'Emmanuel Sr. Sec. Shool, Falna',
    duration: 'April 2021 – July 2022',
    grade: '69%',
    description:
      'Completed my Class 12th from Emmanuel Sr. Sec. School under RBSE board with a focus on Physics, Chemistry, and Mathematics.',
    logo: schoolIcon,
  },
  {
    degree: 'Secondary (Class 10th) – RBSE',
    institution: 'Emmanuel Sr. Sec. Shool, Falna',
    duration: 'April 2019 – May 2020',
    grade: '76%',
    description:
      'Completed my  Class 10th from Emmanuel Sr. Sec. School under RBSE board and secured 76%.',
    logo: schoolIcon,
  }
];
